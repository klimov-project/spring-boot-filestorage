    ...
    >
      <Box sx={{ maxWidth: '640px', pt: 10, pb: 30 }}>
        ...
        <Typography className="row justify-content-md-center mb-3 ">
          <Typography
            variant="body1"
            className="col-lg-9 themed-grid-col text-center"
          >
            {' '}
            Простой сайт, который представляет собой многопользовательское
            файловое облако. Пользователи сервиса могут использовать его для
            загрузки и хранения файлов. Проект создан в рамках работы над
            <a href="https://zhukovsd.github.io/java-backend-learning-course/projects/cloud-file-storage/">
              {' '}
