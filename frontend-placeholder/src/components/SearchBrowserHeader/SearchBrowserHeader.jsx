          ...
          >
            <Button
              ...
              sx={{
                ...
                minWidth: '42px',
                background:
                  'linear-gradient(90deg, rgba(180,73,100,1) 0%, rgba(250,30,30,1) 100%)',
                color: 'white',
                p: 0,
                width: '38px',
                height: '38px',
            ...
            {!isCopyMode && !isCutMode ? (
              ...
              <Box
                sx={{
                  ...
                  background:
                    'linear-gradient(90deg, rgba(16,113,175,1)   0%,  rgba(28,73,163,1) 100%)',
                  transform: 'translateX(-50%)',
                  left: '50%',
                  bottom: 4,
                }}
              >
                ...
                >
                  {isCopyMode && (
                    <ContentCopyIcon
                      sx={{ fontSize: '20px', pt: '1px', mr: 0.5, mb: -0.3 }}
                    />
                  )}
                  {isCutMode && (
                    <ContentCutIcon
